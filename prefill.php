...
$fields = [
    'author_name' =>            ['Your name',             'Adam Ibrahim',                                                ''],
    'author_github_username' => ['Your Github username',  '<username> in https://github.com/adamibrahim',       ''],
    'author_email' =>           ['Your email address',    'adam@hostato.com',                                                ''],
    'author_twitter' =>         ['Your twitter username', '',                    '@{author_github_username}'],
    'author_website' =>         ['Your website',          'https://hostato.com',         'https://github.com/{author_github_username}'],

    'package_vendor' =>         ['Package vendor',        '<vendor> in https://github.com/adamibrahim/email_confirm',   '{author_github_username}'],
    'package_name' =>           ['Package name',          '<package> in https://github.com/adamibrahim/email_confirm',  ''],
    'package_description' =>    ['Package very short description',   'Laravel 5.5 Natively Email confirmation Package',                                     ''],

    'psr4_namespace' =>         ['PSR-4 namespace',       'usually, Adam\\EmailConfirm',   '{package_vendor}\\{package_name}'],
];
